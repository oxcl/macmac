...
- **自动切换容器** — 访问网站时，BoxBox 自动把你路由到对应容器，不需要手动操作。
...
在任意网站上打开弹窗，点击 **创建新账户**。BoxBox 会创建一个未命名的容器（自动命名为"账户 1"、"账户 2"等），在该容器中打开网站，你登录即可。之后可以在弹窗中重命名。
...
如果 BoxBox 对你有用，可以在 [GitHub](https://github.com/oxcl/boxbox) 上给仓库点个 star，或者[捐款](https://oxcl.github.io/boxbox/#donate)。
